...
This policy is intended to support the Chrome Web Store privacy disclosure requirements. Review and update it before publication if the extension's behavior changes.
